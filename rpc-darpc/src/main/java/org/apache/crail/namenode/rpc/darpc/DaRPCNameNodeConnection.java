...
//		LOG.info("LQL debug-createFile-RDMA-DaRPCNameNodeConnection");
//		System.out.println("DaRPCNameNodeConnection-createFile-CrailNodeType "+type.getLabel());

		// 封装一个RpcRequestMessage
		...
		// 构造一个空的RpcResponseMessage
		RpcResponseMessage.CreateFileRes fileRes = new RpcResponseMessage.CreateFileRes();

//		if(type.getLabel()!=0){
//			System.out.println("DaRPCNameNodeConnection-createFile-change node type");
//			fileRes.getFile().setType(type);
//		}
