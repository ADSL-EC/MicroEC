...
public class CoreNode implements CrailNode {
	...
	// add set and get function for syncOperations
	// to make the syncOperations in ReplicasFile consistent with CoreNode
	public LinkedBlockingQueue<CoreSyncOperation> getSyncOperations() {
		return syncOperations;
	}

	public void setSyncOperations(LinkedBlockingQueue<CoreSyncOperation> syncOperations) {
		this.syncOperations = syncOperations;
	}
	
	public static CoreNode create(CoreDataStore fs, FileInfo fileInfo, String path) throws Exception {
	...
	protected CoreInputStream getErasureCodingInputStream(long readHint) throws Exception{
		return fs.getErasureCodingInputStream(this, readHint);
	}

	protected CoreInputStream getDegradeErasureCodingInputStream(long readHint, int[] degradeIndices) throws Exception{
		return fs.getDegradeErasureCodingInputStream(this, readHint, degradeIndices);
	}
	...
	CoreReplicasOutputStream getReplicasOutputStream(long writeHint) throws Exception{
		return fs.getReplicasOutputStream(this,writeHint);
	}
