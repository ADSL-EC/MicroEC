...
//			long startPrefetchMetadata=System.nanoTime();
			prefetchMetadata();
//			long endPrefetchMetadata=System.nanoTime();
//			System.out.println("CoreOutputStream prefetchMetadata "+(endPrefetchMetadata-startPrefetchMetadata));
		}
	...
	StorageFuture trigger(StorageEndpoint endpoint, CoreSubOperation opDesc, CrailBuffer buffer, BlockInfo block) throws Exception {
		// RdmaStoragePassiveEndpoint write
