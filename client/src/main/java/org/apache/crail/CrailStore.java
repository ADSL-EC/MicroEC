...
public abstract class CrailStore {
	...
	// add replicas file
	public abstract Upcoming<CrailNode> createReplicasFile(String path, CrailNodeType type, CrailStorageClass storageClass, CrailLocationClass locationClass, boolean enumerable, RedundancyType redundancyType) throws Exception;
	...
	public abstract void deleteRedundantFile(CrailFile redundantFile) throws Exception;
